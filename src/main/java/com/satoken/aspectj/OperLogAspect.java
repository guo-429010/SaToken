...
public class OperLogAspect {
    ...
    public void boBefore(JoinPoint joinPoint, OperLog controllerLog) {
    ...
    protected void handleLog(final JoinPoint joinPoint, OperLog controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (e != null) {
                sysOperLog.setStatus(Constant.Business_Fail);
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, OperLog log, SysOperLog sysOperLog, Object jsonResult) throws Exception {
        // 设置action动作
